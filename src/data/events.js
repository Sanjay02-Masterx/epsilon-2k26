...
const events = [
      ...
      rounds: [
        {
          ...
          description: "Online quiz of ~20 general electrical core component questions. Teams answer via a shared QR-code website using one mobile phone. Rankings determine progression."
        },
        {
          title: "Round 2 – Design",
          description: "Images of electrical components, principles, and formulae are projected. 10–15 questions, 5 points each. Teams press a digital buzzer (first-come-first-serve) to answer. Unanswered questions pass to the next 3 fastest teams."
        },
        {
...

  {
    ...
    coordinators: [
      ...
      { name: "Swetha S",   phone: "9943246709" }
    ],
    email: "epsilon2k26@gmail.com",
    ...
    details: {
      ...
      requirements: [
        ...
        "Research abstract submitted at registration.",
...

  {
    ...
    details: {
      ...
      rules: [
        "Each team must consist of exactly 2 participants from the same institution.",
...

  {
    ...
    venue: "PSS Lab, Main Block, MSEC",
    coordinators: [
      { name: "Event Coordinator", phone: "epsilon2k26@gmail.com" }
    ],
    email: "epsilon2k26@gmail.com",
    prize: "Winner – Cash Prize | Runner-up – Certificate | Special Awards",
    details: {
      description: [
      ...
      rules: [
        ...
        "Teams of 1–4 members. Cross-department teams allowed.",
        "Online registration mandatory. Abstract (300–500 words) must be submitted at registration.",
      ...
      requirements: [
        "Online registration with abstract submission (300–500 words).",
      ...
      rounds: [
        {
          ...
          description: "Snake & Ladder styled 30-box game board. Teams roll a dice and move accordingly. Each box has a blackout-related task (mandatory completion). Landing on a Ladder = move up + complete task + 1 bonus mark. Landing on a Snake = move down + complete task – 1 penalty mark. No task can be skipped."
        },
        {
