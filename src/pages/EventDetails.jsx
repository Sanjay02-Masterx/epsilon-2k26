    ...
    <div className="relative min-h-screen bg-black text-gray-100 overflow-hidden selection:bg-red-500/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-24 sm:pb-32">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-12 sm:mb-16 items-start">
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Description */}
            {descriptionText && (
              <div className="bg-zinc-900/60 backdrop-blur-md border border-white/5 rounded-2xl p-5 sm:p-7 shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
          ...
          {/* Rules */}
          {rules.length > 0 && (
            <div className="bg-zinc-900/60 backdrop-blur-md border border-white/5 rounded-2xl p-5 sm:p-8 shadow-xl">
              <h2 className="text-lg sm:text-xl font-bold mb-5 sm:mb-6 uppercase tracking-wider flex items-center gap-2" style={{ color: g1 }}>
          ...
          {/* Rounds — full width */}
          {rounds.length > 0 && (
            <div className="bg-zinc-900/60 backdrop-blur-md border border-white/5 rounded-2xl p-5 sm:p-8 shadow-xl md:col-span-2">
              <h2 className="text-lg sm:text-xl font-bold mb-5 sm:mb-6 uppercase tracking-wider" style={{ color: g1 }}>
                Round Structure
              </h2>
      ...
      {showCoordinatorPopup && coordinators.length > 0 && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-zinc-900 border border-white/10 rounded-2xl p-5 sm:p-6 max-w-sm w-full relative shadow-2xl">
            <button
            ...
            <h3 className="text-xl font-bold text-white mb-4">Contact Coordinator</h3>
